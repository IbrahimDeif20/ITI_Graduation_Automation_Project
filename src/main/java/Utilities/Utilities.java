...
public class Utilities {
    ...
    public static void waitForAlertToBeAccepted(WebDriver driver){
        WebDriverWait wait = Utilities.generalWait(driver);
    ...
    public static P06_CheckoutPage fillingDataWithoutSelectNewAddress(WebDriver driver) throws FileNotFoundException {
        new Pages.P06_CheckoutPage(getDriver())
                .enterCompany(DataUtil.getJsonData("CustomerData", "company"))
                .selectCountry(DataUtil.getJsonData("CustomerData", "country"))
                .enterCity(DataUtil.getJsonData("CustomerData", "city"))
